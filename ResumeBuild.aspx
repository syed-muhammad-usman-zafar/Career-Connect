<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="ResumeBuild.aspx.cs" Inherits="WebApplication18.User.ResumeBuild" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="col-12 pt-4">
                             ...
                             <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPhd" runat="server" CssClass="form-control" placeholder="Ex PHD with 9.2 pointer" required></asp:TextBox>
                                </div>
                            </div>
    ...
    <div class="form-group">
        <label>Resume</label>
        <asp:FileUpload ID="fuResume" runat="server" CssClass="form-control pt-2" ToolTip=".doc, .docx, .pdf extensions only" required></asp:FileUpload>
    </div>
</div>
