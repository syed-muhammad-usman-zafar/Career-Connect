<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="WebApplication18.User.Profile" %>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted fa-font-size-sm text-capitalize">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary text-heading-capitalize">
                                          <%# Eval("Name") %>  
                                        </div>
                                    </div>
                                    <hr />
